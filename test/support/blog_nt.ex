defmodule BlogNT do
  @moduledoc """
  Facade for operations, interacting with BlogServerNT.
  """
  import Ecto.Query
  ...
  def create_post(author_id, content) do
    BlogServerNT.call({:create_post, author_id, content})
  end

  def create_comment(author_id, post_id, content) do
    BlogServerNT.call({:create_comment, author_id, post_id, content})
  end
  ...
  def update_post(post_id, params) do
    BlogServerNT.call({:update_post, post_id, Map.new(params)})
  end

  def update_comment(comment_id, content) do
    BlogServerNT.call({:update_comment, comment_id, content})
  end
  ...
  def forget_post(post_id), do: BlogServerNT.call({:forget_post, post_id})
  def delete_comment(comment_id), do: BlogServerNT.call({:delete_comment, comment_id})
